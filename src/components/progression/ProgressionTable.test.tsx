...
describe('ProgressionTable', () => {
  ...
  it('renders table with correct structure', () => {
    render(
      <ProgressionTable periodes={mockPeriodes} matieres={mockMatieres} />
    );
  ...
  it('renders with no periods', () => {
    render(<ProgressionTable periodes={[]} matieres={mockMatieres} />);
  ...
  it('renders with no topics', () => {
    render(<ProgressionTable periodes={mockPeriodes} matieres={[]} />);
