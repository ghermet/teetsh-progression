...
/**
 * Props for the ProgressionTable component
 */
...
/**
 * Timeline table component that renders educational progression data in a grid format.
 *
      ...
      <div className="min-w-max">
        <table className="w-full border-collapse">
          <caption className="sr-only">
            Tableau de progression des matières par périodes
          </caption>
