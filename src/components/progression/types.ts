import type { Matiere } from '../../types/progression.types';

/**
 * Represents a domain tag for visual identification.
 *
 * Used in the progression table to show which domains are active
...
/**
 * Represents data for a specific week in the progression timeline.
 *
...
/**
 * Represents a row in the progression table corresponding to a topic/domain.
 *
