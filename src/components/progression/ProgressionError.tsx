...
/**
 * Error boundary component for progression loading failures.
 *
 * Displays a user-friendly error message when progression data fails to load,
 ...
 */
export function ProgressionError({ error, reset }: ErrorComponentProps) {
  return (
