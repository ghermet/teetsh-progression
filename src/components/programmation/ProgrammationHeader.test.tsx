...
describe('ProgrammationHeader', () => {
  ...
  it('renders the timeline name', () => {
    render(<ProgrammationHeader {...defaultProps} />);
  ...
  it('does not render short description when not provided', () => {
    ...
    render(<ProgrammationHeader {...propsWithoutDescription} />);
    expect(
  ...
  it('does not render year when date is not provided', () => {
    ...
    render(<ProgrammationHeader {...propsWithoutDate} />);
  ...
  it('has correct CSS classes for styling', () => {
    const { container } = render(<ProgrammationHeader {...defaultProps} />);
