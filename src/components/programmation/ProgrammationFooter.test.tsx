...
describe('ProgrammationFooter', () => {
  ...
  it('displays the correct number of weeks', () => {
    render(
      <ProgrammationFooter periodes={mockPeriodes} matieres={mockMatieres} />
    );
  ...
  it('counts matiere correctly', () => {
    ...
    render(
      <ProgrammationFooter periodes={mockPeriodes} matieres={singleMatiere} />
    );
  ...
  it('renders with no periods', () => {
    render(<ProgrammationFooter periodes={[]} matieres={mockMatieres} />);
    expect(screen.getByText('0')).toBeInTheDocument();
    expect(screen.getByText('semaine')).toBeInTheDocument();
  });

  it('renders with no matiere', () => {
    render(<ProgrammationFooter periodes={mockPeriodes} matieres={[]} />);
