...
/**
 * Props for the ProgrammationFooter component
 */
...
/**
 * Footer component that displays summary statistics about the programmation.
 *
 * Shows the total number of periods (weeks) and subjects (matières) in the programmation,
 ...
 * @returns Footer with programmation statistics
 */
export function ProgrammationFooter({
  periodes,
  matieres,
